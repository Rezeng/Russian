...
public class Tetris extends JPanel {
	...
	private int CreateNewBlockState() {
		int Sum = com.zengrui.game.Tetris.Shape.length * 4;
	...
	private boolean[][] getBlockMap(int BlockState) {
		...
		return this.RotateBlock(com.zengrui.game.Tetris.Shape[Shape], Math.PI / 2 * Arc);
	}
	...
	static public void main(String... args) {
		boolean[][] SrcMap = com.zengrui.game.Tetris.Shape[3];
		...
		*/
		...
		Tetris tetris = new com.zengrui.game.Tetris();
